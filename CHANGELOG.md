...
- **`CREATOR-SEAT-BOOTSTRAP.md` runbook 6.8 — cutting a public release**
  enumerates the FIVE public surfaces a release publishes (main commit,
  signed tag, plugin manifest, marketplace manifest, and the host's Release
  object) and the two rules the omission taught. Written because this
