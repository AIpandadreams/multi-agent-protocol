# Channel NORMATIVE CORE [PROTOCOL v3.1] — single source of truth
...
## <SIDE> ENTRY <N> [v3.1] — <date> — <headline> (latest <OTHER SIDE> entry seen: <M>)
...
- **`[v3.1]` is the protocol version stamp.** If a peer's entries carry a
