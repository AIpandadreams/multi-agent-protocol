# Channel NORMATIVE CORE [PROTOCOL v2.9] — single source of truth
...
## <SIDE> ENTRY <N> [v2.9] — <date> — <headline> (latest <OTHER SIDE> entry seen: <M>)
...
- **`[v2.9]` is the protocol version stamp.** If a peer's entries carry a
