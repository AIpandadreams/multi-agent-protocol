...
# The Helper/Builder Agent — PROTOCOL v2.9
...
**Protocol version:** this skill implements PROTOCOL v2.9. Channel entries
carry the `[v2.9]` stamp; a version mismatch with the peer is flagged and parks
