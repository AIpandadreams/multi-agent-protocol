...
# The Helper/Builder Agent — PROTOCOL v3.2
...
**Protocol version:** this skill implements PROTOCOL v3.2. Channel entries
carry the `[v3.2]` stamp; a version mismatch with the peer is flagged and parks
