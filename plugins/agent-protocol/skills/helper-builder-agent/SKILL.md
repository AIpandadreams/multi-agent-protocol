...
# The Helper/Builder Agent — PROTOCOL v3.1
...
**Protocol version:** this skill implements PROTOCOL v3.1. Channel entries
carry the `[v3.1]` stamp; a version mismatch with the peer is flagged and parks
